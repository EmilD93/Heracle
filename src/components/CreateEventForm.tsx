        ...
        <div className="flex items-center justify-between mb-10">
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              disabled={submitting}
              className="flex items-center gap-2 px-5 py-3 bg-white/80 border border-slate-200/80 text-slate-700 rounded-[1.25rem] font-bold text-[14px] hover:bg-slate-50 transition-all shadow-sm focus:outline-none disabled:opacity-50 disabled:cursor-not-allowed"
            >
